...
export default async function ResumeBuilderPage() {
    const [data, versions] = await Promise.all([getResumeBuilderData(), getVersions()])
    ...
    return (
        <div>
            ...
            <p className="text-stone-500 mb-8">
                항목을 토글로 선택하면 우측 미리보기에 실시간 반영됩니다. 미리보기가 곧 최종 PDF이며,
                완성된 구성은 버전으로 저장해 언제든 그대로 다시 받을 수 있습니다.
            </p>

            <ResumeBuilderShell data={data} initialVersions={versions} />
        </div>
    )
}
