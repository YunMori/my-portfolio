...
export default function Hero() {
    ...
    const handleMouseMove = useCallback((e: MouseEvent) => {
        ...
        section.style.setProperty('--mouse-x', `${relX * 100}%`);
        section.style.setProperty('--mouse-y', `${relY * 100}%`);
        ...
        if (svg) {
            ...
            rafRef.current = requestAnimationFrame(() => {
                const dx = relX - 0.5;
                const dy = relY - 0.5;
                svg.style.transform = `translate(${dx * 15}px, ${dy * 10}px)`;
            });
        }
    }, []);
    ...
    return (
        <section
            ref={sectionRef}
            className="relative min-h-[90vh] flex items-center pt-24 pb-12 px-6 overflow-hidden bg-main"
        >
            ...
            <div className="absolute inset-0 overflow-hidden">
                <svg
                    ...
                    style={{ transition: 'transform 80ms ease-out', willChange: 'transform' }}
                ...
                >
                    ...
                    {/* Full-width flowing contours — fade in as a group */}
                    <g className="topo-fullwidth-group" fill="none" strokeWidth="0.8">
                    ...
                    {/* Peak contours — draw in one by one */}
                    <g fill="none" strokeWidth="0.7">
                        <path className="topo-line" stroke="rgba(74,124,89,0.08)" d="M760,130 C870,88 1040,82 1160,132 S1340,248 1360,388 S1290,528 1160,568 S940,584 800,542 S640,440 622,300 S660,190 760,130 Z"/>
                        <path className="topo-line" stroke="rgba(74,124,89,0.11)" d="M800,162 C898,124 1048,118 1154,164 S1312,268 1328,392 S1264,518 1148,554 S944,568 816,528 S666,432 650,306 S684,216 800,162 Z"/>
                        <path className="topo-line" stroke="rgba(74,124,89,0.14)" d="M838,198 C924,163 1054,158 1148,198 S1284,290 1296,396 S1238,506 1136,540 S948,552 832,516 S692,424 678,312 S706,242 838,198 Z"/>
                        <path className="topo-line" stroke="rgba(74,124,89,0.17)" d="M874,238 C950,206 1060,200 1142,238 S1258,316 1268,400 S1214,496 1124,526 S950,536 848,502 S718,416 706,318 S730,268 874,238 Z"/>
                        <path className="topo-line" stroke="rgba(74,124,89,0.20)" d="M908,280 C974,252 1066,246 1138,280 S1232,344 1240,406 S1190,485 1112,512 S952,520 862,488 S742,406 732,324 S754,296 908,280 Z"/>
                        <path className="topo-line" stroke="rgba(74,124,89,0.22)" d="M942,324 C998,300 1072,294 1134,324 S1206,374 1212,412 S1166,474 1100,498 S954,504 876,474 S766,398 758,330 S778,326 942,324 Z"/>
                    </g>
                </svg>
            </div>
            ...
            <div className="max-w-7xl mx-auto w-full grid md:grid-cols-[1.2fr_0.8fr] gap-12 items-center relative z-10">
                ...
                <div className="hero-stagger order-2 md:order-1">
                    ...
                    {/* Badge — slides in from left via hero-stagger nth-child(1) override */}
                    ...
                    {/* Subheading */}
                    <h2 className="text-xl md:text-2xl text-stone-400 font-medium mb-3">
                    ...
                    <div className="flex flex-wrap gap-4">
                        <a
                            href="#projects"
                            className="btn-shimmer px-8 py-3 bg-green-500 text-black font-bold text-sm rounded-full hover:bg-green-400 transition-all shadow-[0_0_20px_rgba(74,124,89,0.3)] hover:shadow-[0_0_30px_rgba(74,124,89,0.5)]"
                        >
                            View Work
                        </a>
                        <a
                ...
                <div className="relative order-1 md:order-2 flex justify-center md:justify-end hero-image-reveal">
                    <div className="relative w-72 h-72 md:w-96 md:h-96">
                        ...
                        {/* Floating experience badge — smooth float instead of bounce */}
                        <div className="hero-float-badge absolute -bottom-6 -left-6 bg-surface border border-stone-800 p-4 rounded-xl shadow-xl">
