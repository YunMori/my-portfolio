    ...
    return (
        <section id="skills" className="py-20 bg-[#0f0f0c] border-y border-stone-900 relative">
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 border-b border-stone-900 pb-6 fade-in-section opacity-0 translate-y-5 transition-all duration-700">
                    <div>
